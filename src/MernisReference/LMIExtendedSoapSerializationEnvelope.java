...
public class LMIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LMIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LMIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LMIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LMIDateTimeConverter dateTimeConverter = new LMIStandardDateTimeConverter();

    public LMIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LMIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LMIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LMIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LMIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LMIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
