...
public class LMIKPSPublicSoap
{
    ...
    public LMIKPSPublicSoap(){}

    public LMIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LMIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LMIExtendedSoapSerializationEnvelope envelope= new LMIExtendedSoapSerializationEnvelope(LMIExtendedSoapSerializationEnvelope.VER11);
